...
** DOIN [s41] Localization Prelude
*** !opt Comments
**** TODO TODO

     - [ ] create new branch for localization
     - [ ] pre-compute leadfield for each cortex and thalami node
           (based on arguments used in reconstruction)
     - [ ] tidy-up (copy) batch for localization
     - [ ]

*** !opt Prepare source localization candidate points
...
size(sel_atl.pnt)
size(sel_geo_deep_thalami.pnt)
size(sel_geo_deep_icosahedron642.pnt)

sel_src = []
sel_src.pnt = [sel_geo_deep_thalami.pnt;sel_atl.pnt;sel_geo_deep_icosahedron642.pnt];
sel_src.vn1 = [sel_geo_deep_thalami.vn1;sel_atl.vn1;sel_geo_deep_icosahedron642.vn1];
sel_src
size(sel_src.pnt)
...
tmp_cfg.grid.pos   = sel_src.pnt;
tmp_cfg.grid.mom   = transpose(sel_src.vn1);
sel_src.lfg        = ft_prepare_leadfield(tmp_cfg);
sel_src.LFG        = cat(2,sel_src.lfg.leadfield{:});

sel_src

save('./mat/sel_src.mat','sel_src','-v7.3')
